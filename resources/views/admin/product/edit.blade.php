                           ...
                           <div class="mb-3">
                            <div class="row align-items-center">
                                <div class="col-1">
                                  ...
                                  <div class="col-2">
                                    <input class="form-control w-15" id="price" name="price" value= "{{ $product->price }}">
                                </div>
                            </div>
                               </div> 
                           <div class="mb-3">
                               ...
                               <div class="mb-3">
                                <div class="row align-items-center">
                                    <div class="col-1">
                                      ...
                                      <div class="col-2">
                                        <input class="form-control" type="number" id="quantity" name="quantity" min="1" max="10" value= "{{ $product->quantity }}">
                                    </div>
                                </div>
                            </div>
